...
/*
	...
	Constructor takes pointer to the first element 
	of the N-th row of matrix.
	Operator[] takes number of column and returns 
	reference to the element of a Matrix.  
*/
